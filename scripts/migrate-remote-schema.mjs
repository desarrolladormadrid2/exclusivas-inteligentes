...
const migrationsByTable = {
  ...
  purchase_orders: [
    ...
    ["supplier_invoice_code", "ALTER TABLE purchase_orders ADD COLUMN supplier_invoice_code TEXT"],
    ["invoice_date", "ALTER TABLE purchase_orders ADD COLUMN invoice_date TEXT"],
    ["payment_terms_snapshot", "ALTER TABLE purchase_orders ADD COLUMN payment_terms_snapshot TEXT"],
    ["payment_due_date", "ALTER TABLE purchase_orders ADD COLUMN payment_due_date TEXT"],
    ["payment_status", "ALTER TABLE purchase_orders ADD COLUMN payment_status TEXT DEFAULT 'Pendiente'"],
    ["payment_paid_at", "ALTER TABLE purchase_orders ADD COLUMN payment_paid_at TEXT"],
    ["payment_reference", "ALTER TABLE purchase_orders ADD COLUMN payment_reference TEXT"],
  ],
  returns: [
...
for (const sql of [
  ...
  "CREATE INDEX IF NOT EXISTS idx_purchase_orders_payment_due ON purchase_orders(payment_due_date, payment_status)",
